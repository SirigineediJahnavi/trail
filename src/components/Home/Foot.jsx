...
function Foot() {
  ...
  return (
    <>
      ...
      <img src={logo} alt="logo" className="w-[100px] mr-0" />
      <h2 className="text-white text-[24px] font-manrope font-bold">crosspe</h2>
    </div>
          <div className="">
            ...
            <span>2021 CoinMarketCap. All rights reserved</span>
          </div>
        </div>
